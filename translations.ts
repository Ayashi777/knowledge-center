...
export const translations = {
  uk: {
    ...
    adminDocs: {
      title: 'Документація',
      description: 'Керування файлами та описами.',
    ...
    dashboard: {
      ...
      subtitle: 'Єдина екосистема технічної документації для професіоналів.',
      description: 'Тут ви знайдете креслення, протоколи випробувань, технічні листи та регламенти для кожного етапу проєктування та будівництва.',
  ...
  en: {
    ...
    adminDocs: {
      title: 'Documentation',
      description: 'Manage files and descriptions.',
    ...
    dashboard: {
        ...
        subtitle: 'A unified ecosystem of technical documentation for professionals.',
        description: 'Find up-to-date drawings, test reports, technical data sheets, and regulations for every stage of design and construction.',
